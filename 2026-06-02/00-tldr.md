...
Sixty-second skim. **Two of the three biggest watchlist threads resolved in a single 36-hour window — and they resolved in *opposite* directions.** **Anthropic beat OpenAI to the SEC** with a confidential S-1 yesterday (Mon, Jun 1) at a **$965B valuation**, targeting an **October listing** — formalizing the Series H close from [2026-05-29](../2026-05-29/) and ratifying the $1T-line crossing in [2026-05-31](../2026-05-31/). And the **Trump AI executive order — postponed on [2026-05-22](../2026-05-22/01-big-lab-moves.md#1-eo-postponed) and re-staged with NSA-in-the-loop on [2026-06-01](../2026-06-01/01-big-lab-moves.md) — was *signed today* as "Promoting Advanced Artificial Intelligence Innovation and Security"** in a *lighter-touch* form than the May 21 draft. Meanwhile **Claude Opus 4.8 (May 28)** with **dynamic workflows** + a **3× cheaper fast mode** + **69.2% SWE-Bench Pro** continues to reset the routing table from [2026-05-22/03 §1](../2026-05-22/03-practical-skills-and-tools.md#1-agent-team-cost) and [2026-06-01](../2026-06-01/03-practical-skills-and-tools.md). For you: the **public-market turn that was a thesis last week is now a filing**, and the **routing-table re-cost from yesterday becomes today's portfolio artifact**.
...
- 🔻 **OpenAI S-1:** was "filing as early as today" on May 22; **not filed by June 2** (~10 working days late vs the May 22 plan). Status: 🟡 → 🟡-slipping. Watch for any Friday filing pattern. Cross-link: [2026-06-01](../2026-06-01/) noted xAI-SpaceX merged-co roadshow targeting **Jun 8 at ~$1.75T** — that becomes the first of the three frontier listings if it holds.
