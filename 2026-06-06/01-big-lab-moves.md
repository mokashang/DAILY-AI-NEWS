...
A converging weekend. The Saturday-after lens on the historic week: **Anthropic's confidential S-1** ([originally filed Jun 1, see 2026-06-02/01](../2026-06-02/01-big-lab-moves.md)) is now *the* live IPO-race anchor — first frontier lab to *officially* announce its path (Rule 135 notice), on the back of a **$65B Series H closed May 28 at ~$965B post-money** and **~$47B ARR run-rate** (4.7× YoY) — vs. OpenAI's still-unannounced confidential S-1 from May 22 ("slipping" per [2026-06-02](../2026-06-02/01-big-lab-moves.md)). **Project Glasswing went operational at scale on June 2**: Anthropic scaled Claude Mythos preview to **~150 new orgs across 15+ countries**, on the back of **10,000+ critical-severity vulnerabilities** surfaced since April — and the AWS/Apple/Cisco/CrowdStrike/Google/JPMorgan/Microsoft/NVIDIA/Palo Alto launch-partner roster reads like a sovereign cyber-clearinghouse — *the same day Trump signed the AI EO* ([2026-06-02](../2026-06-02/01-big-lab-moves.md)) keeping the cyber-half alive on the federal side. And **WWDC is in 48 hours (Mon, June 8, 10 AM PT)** — iOS 27 is expected to open Siri to **Claude, ChatGPT, and Gemini through a new Extensions system**, with the [Apple × Google Gemini Siri partnership tracked from 2026-06-04](../2026-06-04/01-big-lab-moves.md#3-wwdc) likely the first publicly confirmed default. *The state engaged, the labs are going public, the platforms now pick the winners.*
