...
Sixty-second skim. **The metering split is live. Fable 5 is still dark. G7 Évian opens today with all three frontier-lab CEOs in the room for the first time.** Three same-day pivots that re-price the Anthropic-stack cost model *and* the policy backdrop. The **Agent SDK credit pool** went live at 00:01 PT this morning: programmatic Claude now bills against a separate dollar-denominated pool at full API list rates, **claim-to-activate** (silent failure if you skipped the toggle). **Claude Fable 5 + Mythos 5 remain offline** — Day 4 of the export-control suspension; Anthropic's official statement reframed the directive as "a misunderstanding"; **prediction markets price restoration before July 1 at ~85%**, restoration by June 20 at ~5%. And **the 52nd G7 opens today in Évian (Jun 15–17) with Altman, Amodei, and Hassabis attending together for the first time** — Macron personally invited Altman; Wednesday's working lunch puts them in the room with G7 heads of state to discuss **AI infrastructure, networks, and regulation.** There's also a tail event most coverage missed: even when Fable 5 returns, **the free-on-subscription window ends June 22** — after that, Fable 5 moves into the new credit pool at $10/$50 per 1M tokens. Today is also **WWDC 2026 developer-breakout week** (Jun 9 was the keynote; Apple's "Extensions" SDK demos run through this week — watch for the iOS 27 multi-AI picker reveal).
...
4b. **G7 ÉVIAN DAY 1 — Altman + Amodei + Hassabis in the same room for the first time at a G7.** Summit runs Mon–Wed; **Wednesday working lunch** is the set-piece (heads of state + lab CEOs on AI infrastructure, networks, regulation). Wider AI delegation: Mistral · Cohere · Black Forest Labs · Sarvam · Synthesia · Sakana · Meta (Alex Wang) · Salesforce. The three US CEOs walk in **co-signed on a synthetic-DNA / AI bio-threats letter to Congress** — the *narrow* policy ask they're aligned on. Amodei discusses Fable 5 in front of allied heads of state for the first time. → [`01` §3](./01-big-lab-moves.md#3-g7-day1) `#g7 #policy #sovereign-ai #biosecurity`
...
- 🆕 **G7 Évian (Jun 15–17) — three frontier-lab CEOs in the room:** new thread — watch for (a) Wednesday working-lunch readouts, (b) post-summit communiqué AI section, (c) bio-safety / synthetic-DNA policy language, (d) post-summit lab government-affairs and bio-safety hiring within ~30 days.
