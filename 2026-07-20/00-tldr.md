...
> **Continuity note:** Yesterday ([`2026-07-19`](../2026-07-19/)) was a Sunday review that ran the **3-clocks execution block** — Fable-5-free evals captured before the 11:59 PM PT sunset · Sonnet-5-default `CLAUDE.md` routing rule · stateless-MCP migration ahead of the `2026-07-28` RC · public gist writeup. Also carried: **Ode with Anthropic** (Jul 15) FDE-lane application window, and **Gemini 3.5 Pro public silence** at T+2 past the July 17 target. Today extends those threads and adds a fresh Monday stack: **Opus 4.7 is now the enterprise default** (with a silent ~30% tokenizer re-price everyone is paying), the **DeepMind talent-exodus compounds** into Anthropic's pretraining bench, and the **vertical-AI funding tape** put $1.5B+ into legal / app-gen / enterprise-search / preventive-health inside 5 trading days.
