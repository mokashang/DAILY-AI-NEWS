...
*(Note: previous edition in this archive was 2026-07-25. This is a two-months-later refresh — I've cross-linked back where a thread survives.)*
...
- 🆕 **Navier–Stokes / AI-for-open-math** — new thread. First head-to-head between two frontier-lab pipelines on a Millennium-class problem, plus a public credit fight. Follow: the arXiv Alpöge/Buckmaster paper, the Terry Tao commentary thread.
- 🆕 **Anthropic × Google × Broadcom 3.5 GW TPU deal** — extends the "Anthropic-stack focusing decision" thread and the Amazon-AGI-Lab-shutdown thread from [2026-07-25](../2026-07-25/00-tldr.md). Anthropic is now underwriting its next 24 months of compute with a hyperscaler-tier contract.
- 🆕 **Fable 5.1 cache-read cut** — new thread. First time the workhorse tier repriced *within* a model generation. Follow whether Opus 5 gets a matching cut.
- 🆕 **Cognition $2B at $48B** — extends the [2026-05-12](../2026-05-12/) Cognition/Devin thread; ~2× valuation in ~4 months. Follow whether Devin adoption dents Claude Code / Cursor market share.
- ➡️ **FDE market** — the +1,165% YoY from July matured further; postings now ~1,500 US roles, TC bands cluster $300–550K with principal >$1M. Category is still under-supplied.
- ➡️ **Anthropic run-rate revenue** — from ~$47B (July) to ~$65B (end of July, reported August). The IPO story now has real numbers.
- ⬇️ **MCP 2026-07-28 stateless spec** — no longer news. It's the operating floor. What matters now is who has migrated (and who hasn't).
- ⬇️ **Anthropic Fellows Nov 2026 deadline** — closed. If you didn't apply, wait for the next cohort announcement.
- 🆕 **"Model fatigue"** — new thread from CNBC (2026-09-06). Watch enterprise pricing power vs. release cadence.
