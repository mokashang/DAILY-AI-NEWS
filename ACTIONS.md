...
## This week (Sept 14 – Sept 20) — one-Claude / Sponsored Agents / EFS
...
### Earlier this week (Sept 12–16)  — as logged in main before today

Last updated (prior wave): **2026-09-12**
...
## Prior weeks (retained for cross-reference)
...
## Added 2026-07-20 (Monday) — OPUS 4.7 TOKENIZER SILENT RE-PRICING + DEEPMIND EXODUS COMPOUNDS + GEMINI 3.5 PRO T+3 SILENT + GPT-5.6 DAY-11 GA + $1.5B+ VERTICAL FUNDING WEEK

Everything here derives from [today's edition](./2026-07-20/).

### Monday July 20 — 1-hour Opus 4.7 tokenizer bill audit + apply-with-artifact push

| Status | Action | Due | Source |
|---|---|---|---|
| ⚪ | **1-HOUR OPUS 4.7 TOKENIZER BILL AUDIT** — pull `~/.claude/usage.jsonl` last 7 days, divide input+output tokens by 1.30 to estimate Opus-4.6-equivalent cost, compute delta as % of monthly budget; **ship as public gist by Friday** (doubles as portfolio artifact + customer-discovery for cost-router startup wedge) | **Mon start / Fri ship** | [2026-07-20/03 §3](./2026-07-20/03-practical-skills-and-tools.md#3-tokenizer-cost) |
| ⚪ | **Update ME.md focusing decision line** to cite **Jumper + Adler + Pritzel → Anthropic + Karpathy pretraining team** as the validating signal cluster for the Anthropic-stack focus | **Mon** | [2026-07-20/01 §1](./2026-07-20/01-big-lab-moves.md#1-deepmind-exodus) |
| ⚪ | **Set up 3–5 parallel Claude Code sessions in git worktrees (native)** — 1 Opus planner + 2–3 Sonnet workers + 1 Opus verifier; install once, use forever | **Mon night** | [2026-07-20/03 §1](./2026-07-20/03-practical-skills-and-tools.md#1-claude-code-playbook) |
| ⚪ | **Turn on prompt caching on highest-volume Claude project** — more valuable post-tokenizer-change (60–90% input-cost cut, stacks with the tokenizer audit) | **Mon night** | [2026-07-20/03 §3](./2026-07-20/03-practical-skills-and-tools.md#3-tokenizer-cost) |

### Tuesday–Wednesday July 21–22 — apply-with-artifact push (5 targeted with the tokenizer gist attached)

| Status | Action | Due | Source |
|---|---|---|---|
| ⚪ | **Send 5 targeted applications with an artifact attached** — Anthropic Solutions/FDE, OpenAI Deployment Co (post-ChatGPT Work + Tomoro), Harvey ($200M Series C @ $2.1B this week), Emergent ($130M Series C), Hebbia ($130M Series B @ $1B) — attach the tokenizer-audit gist as evidence of production-cost thinking | **Tue–Wed** | [2026-07-20/05 §4](./2026-07-20/05-career-and-startup.md#4-solutions-hunting) |
| ⚪ | **Rewrite résumé to add Meta RL-environment vocabulary** — environment design, reward specification, evaluator wiring, distributed rollout collection, task-suite curation — then apply to Meta Applied AI Eng new-grad org (~3K engineers, 70% new grads on RL tasks) | **Wed** | [2026-07-20/05 §3](./2026-07-20/05-career-and-startup.md#3-rl-env-engineer) |
| ⚪ | **Add CAISI / pre-deployment-eval / capability-benchmarking pack / bank AI-risk to skills vocabulary** + add JPM + Goldman + MSCI + Moody's AI-Risk teams to APPLICATIONS.md — GPT-5.6 was the first CAISI-cleared release; the lane is now shipping, not delayed | **Wed** | [2026-07-20/05 §2](./2026-07-20/05-career-and-startup.md#2-caisi-lane) |

### Thursday July 23 — build the Sol/Terra/Luna tier picker
...
| ⚪ | **Extend router to include Opus 4.7 + Sonnet 4.6 + Haiku 4.5** — completes the 3-provider × multi-tier comparison table | **Thu** | [2026-07-20/03 §2](./2026-07-20/03-practical-skills-and-tools.md#2-provider-router) |

### Friday July 24 — ship the tokenizer audit + DeepSeek deprecation deadline

| Status | Action | Due | Source |
|---|---|---|---|
| ⚪ | **SHIP THE OPUS 4.7 TOKENIZER-AUDIT GIST PUBLICLY** — headline the delta % + one-line mitigation (Opus-orchestrator/Sonnet-worker split) | **Fri** | [2026-07-20/03 §3](./2026-07-20/03-practical-skills-and-tools.md#3-tokenizer-cost) |
| ⚪ | **DEEPSEEK `reasoner` → `v4-flash` (NOT `v4-pro`) — final migration deadline Fri Jul 24 15:59 UTC** — carried from [2026-07-16](./2026-07-16/); silent capability downgrade if you route wrong | **Fri 15:59 UTC** | [2026-07-16/00](./2026-07-16/00-tldr.md) |
| ⚪ | **3 customer-discovery DMs** to Claude-Code-heavy friends: run the audit on their bill, hand them a number, ask *"would you pay $X/mo for this to run automatically and cap you at $Y?"* — real customer discovery for the cost-router wedge in [STARTUPS.md](./STARTUPS.md) | **Fri** | [2026-07-20/03 §3](./2026-07-20/03-practical-skills-and-tools.md#3-tokenizer-cost) |

### Weekend July 25–26 — HAL/HAS-Bench/AlphaEval reading + STARTUPS re-rank + DeepMind APAC deadline (Sun)

| Status | Action | Due | Source |
|---|---|---|---|
| ⚪ | **Read Holistic Agent Leaderboard (HAL, arXiv 2510.11977) end-to-end**; skim HAS-Bench (2607.04329) + AlphaEval (2604.12162) — the *ImageNet moment for agent eval infrastructure*; highest ROI-per-hour interview prep this month | **Sat** | [2026-07-20/04 §1](./2026-07-20/04-research-progress.md#1-agent-benchmarks) |
| ⚪ | **STARTUPS.md re-rank** — promote **agent-identity/scope-management** (Oak $60M seed precedent) and **scientific-agent eval harnesses** (Jumper → Anthropic signal) into top-3 slots | **Sat** | [2026-07-20/02 §4](./2026-07-20/02-new-emerging.md#4-oak) + [2026-07-20/05 §5](./2026-07-20/05-career-and-startup.md#5-health-lane) |
...
| ⚪ | **DeepMind APAC "AI for the Planet" accelerator — deadline SUN Jul 26** (carried from [2026-07-14](./2026-07-14/)) — submit if scientific-agent harness reaches an artifact by Sat | **Sun Jul 26** | [2026-07-14/01](./2026-07-14/01-big-lab-moves.md) |
...
## Added 2026-07-02 (Thursday) — cost-aware config + AI-for-Science app

Rolls up alongside the existing week block below. All from [today's edition](./2026-07-02/).

### Thursday July 2 — cost-aware Claude Code artifact tonight

| Status | Action | Due | Source |
|---|---|---|---|
| ⚪ | **Ship "cost-aware Claude Code config" gist**: (a) 1h `cache_control` override on system prompt + tool defs, (b) `PreToolUse` hook filtering pytest/go-test/npm-test output to failing lines, (c) trimmed <200-line CLAUDE.md + one `.claude/skills/*/SKILL.md`. Log per-session cost before/after; commit + push to public gist | Tonight | [2026-07-02/03 §1](./2026-07-02/03-practical-skills-and-tools.md#1-prompt-cache) · [§3](./2026-07-02/03-practical-skills-and-tools.md#3-hooks) |
...
| ⚪ | Verify Fable 5 vs Opus 4.8 fallback behavior on one coding-agent workflow; log false-positive rate | This week | [2026-07-02/01 §1](./2026-07-02/01-big-lab-moves.md#1-fable5) |

### By Friday July 3 — apply + attach today's artifact

| Status | Action | Due | Source |
|---|---|---|---|
| ⚪ | **Apply: Anthropic — FDE, Applied AI** — attach the cost-aware config gist + a 1-page "Karp / Uber / Lindy → what I'd do about it" write-up | Fri | [2026-07-02/05 §2](./2026-07-02/05-career-and-startup.md#2-anthropic-fde) |
| ⚪ | **Apply: Baseten** — platform-eng / FDE (tripling headcount at $13B post) | Fri | [2026-07-02/05 §1](./2026-07-02/05-career-and-startup.md#1-baseten) |

### By Saturday July 5 — Science credit-grant draft (deadline July 15)

| Status | Action | Due | Source |
|---|---|---|---|
| ⚪ | **Draft Anthropic AI-for-Science $30K credit-grant application** — stepwise-verifiable science-agent workflow, cite SciAgentArena as eval substrate | Sat | [2026-07-02/01 §6](./2026-07-02/01-big-lab-moves.md#6-anthropic-science) · [SciAgentArena](./2026-06-28/04-research-progress.md) |
| ⚪ | Pick 2 YC S26 companies from launch page; cold-email as founding engineer | Sat | [2026-07-02/05 §3](./2026-07-02/05-career-and-startup.md#3-yc-s26) |

### Weekend — portfolio

| Status | Action | Due | Source |
|---|---|---|---|
| ⚪ | Implement **initializer + coding-agent + `claude-progress.txt`** pattern on one portfolio project; run a nightly refactor agent | Weekend | [2026-07-02/03 §2](./2026-07-02/03-practical-skills-and-tools.md#2-long-running) |
| ⚪ | Add **MoE routing / long-context eval / non-NVIDIA inference** to LinkedIn skills; cite LongCat-2.0 evidence | This week | [2026-07-02/02 §1](./2026-07-02/02-new-emerging.md#1-longcat) |
