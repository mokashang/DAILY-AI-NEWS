...
|---|---|---|---|
| **Anthropic $30–50B raise at up to ~$950B post** | 🟢 CLOSED | **2026-05-28:** CLOSED at **$65B Series H, $965B post-money** — surpasses OpenAI's $852B last-private mark for the first time. Anthropic now the most valuable private AI company in the world. Revenue **$47B run rate** (up from $30B earlier in 2026), TTM **~$10B**. Anchor investor set not yet fully disclosed publicly. ([2026-06-05/01 §2](./2026-06-05/01-big-lab-moves.md#2-anthropic-65b)) | Anchor-investor disclosure; whether any of MGX / UK Sovereign / SoftBank Vision Fund 3 / Lightspeed / GIC anchored; secondary-share liquidity terms; how the $965B reads in the IPO prospectus |
...
| **Anthropic IPO path (confidential S-1)** | 🟢 FILED | **2026-06-01:** Anthropic **confidentially filed a draft S-1 with the SEC** — *beating OpenAI to the filing.* **Morgan Stanley + Goldman Sachs + JPMorgan leading** (Bloomberg June 3). ~$1T-class debut as soon as Q4 2026; "first-mover IPO edge set to widen lead over OpenAI" (Bloomberg). ([2026-06-05/01 §1](./2026-06-05/01-big-lab-moves.md#1-anthropic-ipo)) | Public S-1 (revenue mix: Claude Code attribution, vertical splits, enterprise vs API); roadshow window; how the $1.25B/mo Colossus bill reads; first-day comp comparisons with OpenAI |
...
| **Rhoda AI $450M Series A (robotics intelligence — FutureVision)** | 🟢 NEW | **2026-06-05:** Closed after 18 months in stealth. **Video-predictive control** foundation model for robotic intelligence. Largest first-round AI raise for a robotics-foundation-model company. ([2026-06-05/02 §1](./2026-06-05/02-new-emerging.md#1-robotics-foundation-models)) | First FutureVision customer/partner reveals; head-of-eng hires; whether a third $100M+ robotics-foundation round closes inside 90 days (= durable category) |
| **Genesis AI $105M seed (robotics foundation model — GENE-26.5)** | 🟢 NEW | **2026-06-05:** Khosla-backed; foundational AI for robotics; first model **GENE-26.5** unveiled in late May. ([2026-06-05/02 §1](./2026-06-05/02-new-emerging.md#1-robotics-foundation-models)) | GENE-26.5 benchmark/capability reveals; founding-team additions; whether Series A closes within 6 months at $1B+ |
| **Mach Industries $300M (defense AI)** | 🟢 NEW | **2026-06-01:** $300M Government/Defense/Public Sector round. Part of an all-time-record year for defense-tech VC (Crunchbase). ([2026-06-05/02 §2](./2026-06-05/02-new-emerging.md#2-mach-300m)) | First Mach product reveal; Pentagon contract count; whether defense-tech exits begin in 2026 |
| **Verge Labs (frontier lab for human disease biology — CNS)** | 🟢 NEW | **2026-05-27:** Public launch as a frontier AI lab building foundation models of human disease biology. Trained on **12,000+ human brain samples** (one of the largest proprietary multimodal CNS datasets ever assembled). Second publicly-announced vertical-bio frontier lab after Isomorphic. ([2026-06-05/02 §3](./2026-06-05/02-new-emerging.md#3-verge-labs)) | First clinical-endpoint result; partnership/funding round disclosures; founding-team hiring profile; whether a third vertical-bio frontier lab emerges in 60 days |
| **SAP × Prior Labs acquisition (EU frontier lab consolidation)** | 🟡 NEW | **2026-05-XX:** SAP announced agreement to acquire Prior Labs to establish a globally leading frontier AI lab in Europe. ([2026-06-05/02 §4](./2026-06-05/02-new-emerging.md#4-sap-prior-labs)) | Deal close date; lab name + leadership; whether the EU-sovereignty narrative drives a second sovereign-anchored AI lab announcement |
| **AWS Bedrock AgentCore Runtime GA (3-way runtime race)** | 🟢 NEW | **2026-05-XX (gap window):** AWS shipped AgentCore Runtime GA. The agent-runtime market is now explicitly 3-way: **Google Antigravity 2.0** + **AWS AgentCore** + **Azure Agent Framework** (post-Build 2026 with MAI). All three: "one API call → sandboxed agent in isolated environment." ([2026-06-05/02 §5](./2026-06-05/02-new-emerging.md#5-aws-agentcore)) | Which "Docker-for-agents" portability shim wins; AgentCore hiring volume; whether Anthropic ships its own runtime control plane |
...
| **Claude Opus 4.8 / dynamic workflows** | 🟢 SHIPPED | **2026-05-28:** Opus 4.8 released — 41 days after Opus 4.7; **`/effort` (low → xhigh → ultracode)**, **dynamic workflows** orchestrating up to **1,000 parallel subagents** in one prompt, cheaper "fast mode," **~4× fewer un-flagged coding flaws** vs 4.7; standard pricing unchanged. Available on Max / Team / Enterprise + API. Demoed primitive: **repo-scale migrations from kickoff to merge in one session.** ([2026-06-05/01 §3](./2026-06-05/01-big-lab-moves.md#3-opus-4-8)) | Reliability at the 1,000-agent ceiling; independent reproductions of the 4× honesty claim; Enterprise pricing detail for dynamic workflows; whether workflows ship to Pro tier; first major workflow-library OSS project |
| **Microsoft MAI model line (independence from OpenAI)** | 🟢 SHIPPED | **2026-06-02 (Build 2026):** **MAI-Thinking-1 + 6 in-house models** unveiled. MAI-Thinking-1 = **35B active params, 256K context, trained from scratch on commercially-licensed data with NO third-party distillation**. MAI-Code-1-Flash, MAI-Image-2.5, MAI-Transcribe-1.5 also shipped. Claimed **10× cost efficiency over GPT-5.5** on McKinsey-tuned workload. Nadella keynote: **"optionality."** ([2026-06-05/01 §4](./2026-06-05/01-big-lab-moves.md#4-microsoft-mai)) | First independent Arena/MCP-Atlas rankings; Foundry-customer pin-rates to MAI vs OpenAI; whether Azure-OpenAI commit step-downs follow within 60 days; how MAI safety/release process compares to OpenAI/Anthropic |
| **Gemini 3.5 (Flash shipped; Pro pending)** | 🟢 | **2026-06-05 UPDATE:** Gemini 3.5 Flash now **default in Gemini app + AI Mode in Search globally**. Benchmarks: **Terminal-Bench 76.2%, GDPval-AA 1656 Elo, MCP-Atlas 83.6%, CharXiv 84.2% — outperforms Gemini 3.1 Pro at <½ cost.** Gemini 3.5 **Pro** in testing, "coming next month" (~July 2026). Strengthened cyber + CBRN safeguards. ([2026-06-05/01 §5](./2026-06-05/01-big-lab-moves.md#5-gemini-35)) | Gemini 3.5 Pro launch + pricing; whether Claude/OpenAI cut prices in response; Flash adoption curve in agent stacks; whether MCP-Atlas becomes the new "GPQA Diamond" of agents |
