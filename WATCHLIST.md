...
|---|---|---|---|
| **Anthropic $30–50B raise at up to ~$950B post** | 🟢 RESOLVED — but bigger | **2026-05-28: CLOSED as Series H at $65B / $965B post-money** (Altimeter/Dragoneer/Greenoaks/Sequoia co-leads + Capital Group/Coatue/D1/GIC/ICONIQ/XN + strategic Samsung/SK Hynix/Micron; $15B is previously-committed hyperscaler money incl. $5B Apr-Amazon). **Demand outran consensus by ~2×** (rumored $30B → actual $65B at roughly the same valuation premium). Run-rate revenue ~$47B at close | Anthropic IPO timing (Oct 2026 target); secondary market activity; founder-recycling from any pre-IPO tender |
...
| **Cognition (Devin) $1B at $26B** | 🟢 RESOLVED | **2026-05-27 CLOSED:** Lux/General Catalyst/8VC co-leads; Ribbit/Atreides/Founders Fund; **$492M ARR, +50% MoM × 6 mo, ~90% of own code AI-written**; customers Mercedes-Benz/NASA/Goldman/Santander; **2.5× valuation in 8 months** | "Agent self-coding ratio" (dogfood %) becoming a tracked metric; Cognition's next ARR print; whether competing coding-agent cos (Cursor, Replit, Codeium) match publishing self-coding ratios |
...
| **Claude Opus 4.8** | 🟢 SHIPPED | **2026-05-28:** GA'd 41 days after 4.7. Same pricing, **Fast Mode 3× cheaper / 2.5× faster**; agentic coding 64.3→69.2%, knowledge work 1753→1890, ~4× less likely to leave own flaws unflagged. **Mid-conversation system messages** (cache-preserving steering). **Effort selector** low/medium/high. GA on GitHub Copilot same day. Teases **"Mythos-class for all customers" next** | Mythos-class GA window; whether 4.9 ships on a sub-41-day cadence; Sonnet 4.7 release |
| **Claude Code Dynamic Workflows (research preview)** | 🟡 NEW | **2026-05-28:** Claude writes a **JS orchestration script** for sub-agent trees; **cap 1,000 agents / 16 concurrent**; CLI + Desktop + VS Code; Max/Team/Enterprise. Canonical demo: end-to-end codebase migration vs. test suite | GA window; first public Dynamic-Workflows showcase repo; whether the JS-script-as-plan pattern crosses to other lab agent runtimes; "lines-of-code-migrated per dollar conditional on test-green" emerging as a benchmark |
| **OpenAI Frontier Governance Framework** | 🟡 NEW | **2026-05-29:** Public projection of internal Preparedness Framework onto **CA SB 53 (Transparency in Frontier AI Act) + EU AI Act GPAI CoP**; covers cyber offense, CBRN, harmful manipulation, loss of control; model reporting, security risk mgmt, incident response, external expert input | Anthropic / Google DeepMind / Microsoft parity disclosures; AI-GRC startup wedges naming themselves against this vocabulary; CA SB 53 enforcement signals; EU AI Act CoP enforcement signals |
...
| **Anthropic international hiring (EMEA + APAC)** | 🟡 NEW | **2026-05-28:** **Milan office opens (6th in Europe)**; **Seoul office opening soon — KiYoung Choi as Representative Director of Korea**. London tracks to 800 employees; Munich + Paris expected "a lot bigger". Anthropic plans to **triple international workforce**. Korean usage 3.5× expected per-capita | Specific Milan / Munich / Paris / Seoul JD postings within 30 days; whether OpenAI matches with EU office openings; Tokyo office (most-likely next after the June-10 Code w/ Claude Tokyo event) |
...
| **GroupMemBench — multi-party-conversation memory (arXiv 2605.14498)** | 🟡 NEW | **2026-05-29:** Benchmarks LLM agent memory in **multi-party** conversations (not single-user); best system reaches **only 46.0% avg accuracy**. Pairs with the real-tool / real-user evaluation thread. | Whether Mem0 / EverMemOS / LangMem publish multi-party numbers; whether speaker-attribution-aware memory architectures emerge; production adoption signals from Slack-bot / family-assistant style products |
