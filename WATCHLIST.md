...
| **The IPO wave as an asset-class shift (SpaceX + OpenAI + Anthropic)** | 🟢 | **2026-06-04:** both lab S-1s now confidentially filed (OpenAI 5-22 at $852B target; Anthropic 6-1 at $965B). Frontier AI is now formally a public-market asset class | First prints; whether public markets underwrite frontier-AI economics; founder-recycling from liquidity events |
| **OpenRouter $113M Series B at $1.3B (multi-model routing)** | 🟢 NEW | **2026-06-04 (closed May 26):** CapitalG lead; NVentures, ServiceNow Ventures, a16z, Menlo + strategic NVIDIA/Snowflake/Databricks; weekly token volume 5T → 25T in 6 mo | Whether routing platform competitors raise $50M+ within 60 days; enterprise Snowflake/Databricks integrations; first "routing-policy / per-tenant analytics" company funded on top |
| **Claude Opus 4.8 GA (May 28) — dynamic workflows + effort controls** | 🟢 NEW | **2026-06-04:** SWE-Bench Pro 69.2 · OSWorld-Verified 83.4 · HLE 57.9 · ~4× less silent-bug code vs 4.7; **dynamic workflows in Claude Code** (`ultracode` setting); fast mode 3× cheaper | Adoption rate vs 4.7 on real workloads; benchmark deltas vs Gemini 3.5 Pro at GA; user-visible cost effects post-June-15 metering |
...
| **DeepMind ~$80–90M Contextual AI license-and-hire (~20 researchers)** | 🟢 NEW | **2026-06-04:** RAG-research consolidation under Google via licensing structure | Whether OpenAI/Anthropic do analogous license-and-hire deals (Karpathy-style hire vs Contextual-style license); next research-team consolidation |
