...
|---|---|---|---|
| **Anthropic Series H — $65B at $965B (CLOSED)** | 🟢 NEW | **2026-05-28:** Closed at **$65B / $965B post-money** — Altimeter/Dragoneer/Greenoaks/Sequoia leads; surpasses OpenAI's $852B (March 2026); rare 8th-round milestone (Facebook/Lyft/Discord/Slack peer group); $47B run-rate disclosed earlier in May; re-rate $380B (Feb) → $965B (May) is among steepest private re-ratings on record | Secondary-market liquidity (likely opens before public listing); whether secondary trades at premium or discount to primary; founder-cohort recycling pattern through 2026-2027 |
| **Anthropic $30–50B raise at up to ~$950B post** | 🟢 SUPERSEDED | **2026-05-28:** Closed at $65B / $965B (folded into the Series H row above) | (see Series H row) |
...
| **OpenAI IPO path (confidential S-1)** | 🟡 SLIPPED | **2026-06-26 (NYT):** OpenAI **leaning toward 2027 listing**, easing off Q4 2026 path after SpaceX IPO cooled and broader tech softened. Confidential S-1 filed **June 8** still on file. Altman framing: "things we want to do that are likely easier as a private company." Reverses the [2026-05-22] Sept-2026 thread. | Whether 2027 firms up vs slips further; public S-1 (revenue mix: API vs ChatGPT vs ads vs enterprise); whether ad-revenue ($100M Cannes print) is broken out; roadshow window |
| **Anthropic IPO path (October 2026 target)** | 🟡 SOFT | **2026-06-2026:** Anthropic **confidentially submitted draft S-1**; no public date. Series H ($65B at $965B) reduced IPO urgency. **2026-05-22:** had targeted **October 2026** listing | Whether any concrete 2026 path remains given the OpenAI slippage; whether the H-round is treated as "pre-IPO" or "instead of IPO"; how the $1.25B/mo Colossus bill reads in a prospectus |
...
| Thread | Status | Last move | Watching for |
|---|---|---|---|
| **GPT-5.6 Sol / Terra / Luna (limited preview)** | 🟢 NEW | **2026-06-26:** Launched **at U.S. government request, limited preview only** — Sol **$5/$30 per 1M** (flagship, matches 5.5 pricing), Terra **$2.50/$15** (~2× cheaper than 5.5 mid), Luna **$1/$6** (budget); partner list shared with the U.S. government; GA "in the coming weeks." Mirrors the Mythos-clearance regime applied to OpenAI. | GA date; first publicly named preview partners (reveals OpenAI's enterprise pecking order); how the preview list maps to the Mythos-cleared list (likely overlap); Realtime-3 voice as a separate beat |
| **Claude Fable 5 + Mythos 5 (Mythos-class tier above Opus 4.8)** | 🟢 NEW | **2026-06-09:** Mythos-class tier launched. Fable 5 + Mythos 5 share weights; **classifier layer** is the only difference — Fable 5 hands flagged requests to Opus 4.8 with a user-visible handoff. **Pricing $10/$50 per 1M (Fable 5)**; SWE-Bench Pro 80.3% (vs GPT-5.5's 58.6%). Productionizes the May "dual-model sanitiser" thesis. | Whether Fable 5 cleared by U.S. (currently restricted, only Mythos 5 cleared June 27); whether the classifier-layer architecture becomes a first-class API feature for non-Anthropic customers; benchmark-coverage independent replication |
| **Claude Opus 4.8 / Haiku 4.5 — GA in Microsoft Foundry on Azure** | 🟢 NEW | **2026-06-2026:** Opus 4.8 + Haiku 4.5 GA in the Azure Messages API — Azure-native identity/billing/governance + optional US data-zone. Anthropic now ships on **all 3 hyperscalers + own API.** | Foundry-specific Claude FDE postings (Microsoft + Anthropic); whether Teams parity for Claude Tag follows; whether AWS/Google parity moves (e.g. Bedrock-native Foundry feature parity) |
...
| **Trump AI/cybersecurity executive order (pre-release model review)** | 🟡 STALLED — DE FACTO REGIME IS DIFFERENT | **2026-06-30:** EO still **unsigned**; the *actual* release regime is **bilateral, per-organization, written clearance** by Commerce — see the Mythos-5 thread (cleared June 27) and the GPT-5.6 limited-preview thread (June 26). The drafted "voluntary 90-day pre-release review" never came online; the case-by-case clearance model is what's enforced. **2026-05-22:** signing pulled, Trump "hates regulation" | Whether the EO is ever signed (low probability) vs whether Commerce formalizes the clearance regime in regulation; how many additional clearance letters Lutnick issues by Q3 |
| **U.S. case-by-case frontier-model clearance regime (Mythos-5 precedent)** | 🟡 NEW | **2026-06-27:** Commerce Sec Lutnick clears **Mythos 5 to ~100 named US critical-infrastructure orgs**; no export license required for the cleared list; **Fable 5 stays restricted**. **2026-06-12:** Mythos + Fable 5 both put under export controls; Anthropic pulled both globally. Negotiated by ~2 weeks of daily talks. **2026-06-26:** OpenAI's GPT-5.6 launches in a parallel "limited preview at U.S. gov request, partner list shared with the government" posture. | Identities of the ~100 cleared orgs (each is a hiring surface); whether Fable 5 gets a parallel clearance letter; OpenAI's first cleared partner names; whether the regime spreads to other labs (Google/Meta/xAI); first compliance-tooling startup raise |
...
| **Anthropic–Google–Broadcom multi-GW compute partnership** | 🟢 NEW | **2026-06-2026:** Announced; multi-gigawatt next-gen compute commitment; pairs with the May Colossus contract — total Anthropic compute commitments now >$60B over 4 yrs | First gigawatt online; Anthropic disclosed forward-compute cost in any prospectus / S-1 update; competitive responses from OpenAI–Broadcom Jalapeño track |
| **OpenAI–Broadcom Jalapeño custom chip** | 🟡 NEW | **2026-06-24:** OpenAI's first custom-designed AI chip, co-designed with Broadcom; vertical-integration play matching Anthropic's TPU lock-in. First production volume not yet dated. | Tape-out → first-silicon date; first production deploy date; whether Jalapeño shifts OpenAI's cloud-cost trajectory enough to affect IPO timing |
| **Alphabet $80B raise for AI compute** | 🟢 NEW | **2026-06-2026:** Announced — **$30B Class A/C public offering + $10B private from Berkshire Hathaway + $40B ATM**. Berkshire participation = unusual value-investor endorsement of AI capex thesis. | First deploy of proceeds; whether other hyperscalers follow with similar-scale raises; Berkshire commentary at next shareholder letter |
...
| Thread | Status | Last move | Watching for |
|---|---|---|---|
| **Karpathy → Anthropic (pre-training automation)** | 🟡 | **2026-06-30:** Team output still quiet through June; no shipped artifacts visible. **2026-05-22 (announced May 19, started this week):** Andrej Karpathy joins **Anthropic's pre-training team**, launching a **new group using Claude to accelerate pre-training research** | What the team ships; whether it's the production face of the PostTrainBench / recursive-self-improvement thread; downstream "AI-does-AI-R&D" tooling startups; talent-market follow-on (Anthropic queue thickening) |
| **Mythos-5 cleared-customer deployment hiring wave (Anthropic Mission Programs)** | 🟡 NEW | **2026-06-27 (event):** Anthropic now has a Day-1 product to deploy into ~100 cleared US critical-infrastructure orgs. Expect JD volume spike inside 14 days. | First posted JDs explicitly mentioning "critical-infrastructure deployment" or "Mythos 5"; whether Anthropic stands up a separate "Mission Programs" or "Public Sector" sub-org; comp bands |
| **OpenAI GPT-5.6 limited-preview partner list** | 🟡 NEW | **2026-06-26:** Partner list private but "shared with the U.S. government." First leaks expected within ~14 days. | Specific partner names (each becomes an FDE-deployment customer); whether the list overlaps with Mythos-5 cleared orgs; whether OpenAI Deployment Co staffs against this list |
| **FDE labor-market re-price (June 2026 data)** | 🟢 | **2026-06-30:** AI Engineer postings **+109% YoY**; **FDE +800%, $450K+ TC**; LLM specialists **$220–280K, +135.8% demand**; AI-skill wage premium **25%→56% YoY** (PwC); "hired on delivery evidence — repos, deployed agents, eval suites." Companies close **<25 days**, **≤3 rounds**. | Whether the wage premium holds above 50% through Q4; whether the AI-Engineer-#1 ranking holds; whether new-grad-MLE-comp bands move with the senior tier |
...
| **Real-tool agent benchmarks (MCP-Atlas, Tool Decathlon)** | 🟡 | **2026-05-22:** eval shifts from mocks to *real* tools — **MCP-Atlas** (Scale, arXiv 2602.00933; real MCP servers, agent must discover tools) + **Tool Decathlon/Toolathlon** (ICLR 2026, arXiv 2510.25726; 32 apps / 604 tools, execution-based eval) | Whether labs report MCP-Atlas/Toolathlon in release notes; eval-against-real-tools as a recurring-revenue startup wedge; whether these become standard FDE-interview vocabulary |
| **Efficient Benchmarking of AI Agents (arXiv 2603.23749)** | 🟢 NEW | **2026-03-24 → June trending:** Optimization-free protocol — evaluate only on tasks with 30–70% historical pass rates → **44–70% reduction in eval cost with high rank fidelity.** Letterhead-ready methodology paper for any portfolio-eval project. | Adoption in labs' release-note eval suites; whether HAL / Judgment Labs integrate the middle-band filter; first SMB eval-as-a-service that defaults to it |
| **Holistic Agent Leaderboard (arXiv 2510.11977)** | 🟢 NEW | **2026-06 trending:** Argues eval is infrastructure-bottlenecked, not just methodology-bottlenecked; ships a public leaderboard with standardized execution environment + per-step token/latency/tool-call traces + scaffolding-decoupled comparisons | Whether labs publish HAL scores in release notes; HAL-shaped private substrates as a startup wedge; standardization across multi-lab comparisons |
| **Deep-research agent benchmarks (DeepResearch Bench, MiroEval, ResearchGym)** | 🟢 NEW | **2026-Q2 cluster:** DeepResearch Bench (arXiv 2506.11763) + MiroEval (arXiv 2603.28407, multimodal) + ResearchGym (arXiv 2602.15112, real research tasks). The "agent does research with citations" subfield is now recognizable. | Vertical deep-research-agent products (equity research, clinical-lit research, patent landscape); whether labs report DeepResearch / MiroEval scores in flagship release notes |
| **Uncertainty Quantification in LLM Agents (arXiv 2602.05073)** | 🟢 NEW | **2026-06 trending:** Survey + taxonomy — epistemic/aleatoric/computational uncertainty; mitigation depends on type. Generative form of the Appier "Answer, Refuse, or Guess?" thread. | Whether UQ-aware orchestration becomes a startup category; whether labs ship UQ as a first-class API output; UQ vocabulary in Safety / Responsible-AI job postings |
