...
| **OpenAI IPO path (confidential S-1)** | 🟡 | **2026-07-10 UPDATE:** reporting (Motley Fool + NAI500) says OpenAI has **slipped its listing to 2027**, ceding first-to-IPO position to Anthropic. Confidential S-1 was filed May 22 but roadshow window pushed. | Whether OpenAI holds the 2027 target or pulls it back into 2026; comparative revenue mix vs Anthropic once both S-1s are public |
| **Anthropic IPO path (now front-of-queue)** | 🟡 | **2026-07-10:** reported **ahead of OpenAI to IPO**, ARR run-rate **~$47B** (from ~$30B earlier in 2026); confidential filing already at $965B valuation (Fortune Jun 1). | First public S-1; roadshow window; whether Anthropic prices ahead of the OpenAI 2027 timeline; comparative revenue mix (API vs Claude Cowork vs Government vs Solutions/FDE) |
| **Norm Ai $120M Series C @ $1.2B (Legal-AI unicorn, Khosla lead)** | 🟢 NEW | **2026-07-07:** first "regulation-native vertical agent" unicorn — Khosla lead + Blackstone / Bain / Coatue / Vanguard / New York Life / TIAA follow-on; $30T+ AUM addressable | First healthcare-compliance / AI-assurance equivalent inside 90 days; whether Norm's supervisory-agent pattern gets applied to *AI deployment* itself |
| **AI-infra funding week — Baseten $1.5B F / SambaNova $1B F / Together $800M C / Prime Intellect $130M A @ $1B / Bespoke Labs $40M A / ZML LLMD** | 🟢 NEW | **2026-07-06 to 07-08:** ~80% of VC $ this week to AI infra; "BYO-agent infra" (Prime Intellect) and "environments-as-a-service" (Bespoke) crystallize as distinct layers; ZML backed by LeCun / Delangue for chip-agnostic inference | Q3 hiring windows (Sep–Dec) at each; whether a second $1B+ inference round lands inside 30 days; Meta Compute [`01` §5] impact on procurement |
| **Zeroth $74M Pre-A (Chinese home humanoid, Ant Group lead)** | 🟢 NEW | **2026-07-08:** consumer-embodied-AI as a distinct funded category; robotics YTD $18.8B (past all of 2025) | Whether a US payments-adjacent player (Stripe/Block/PayPal) leads a home-humanoid round in response; Embodied.cpp community traction |
...
| Thread | Status | Last move | Watching for |
|---|---|---|---|
| **GPT-5.6 (Sol / Terra / Luna)** | 🟢 RESOLVED | **2026-07-09:** Sol/Terra/Luna family GA after CAISI review. Sol = frontier (SOTA on Terminal-Bench 2.1), Terra ~½ GPT-5.5 cost, Luna cheapest. Segmentation is the launch story. | Terra as default-workload SKU inside 3 wks; Sol vs Opus 4.7 on SWE-Bench Verified / ARC; whether Realtime-3 voice ships next |
| **Grok 4.5 + Cursor-tuned coding variant + 2T-param successor (SpaceXAI)** | 🟢 NEW | **2026-07-08:** Grok 4.5 GA at **$2 in / $6 out per Mtok**, Musk framed as "Opus-class" faster; Cursor-tuned coding variant; ~2T-param successor training now, Aug availability targeted | Cursor DAU spike; Anthropic / OpenAI coding-SKU price response inside 30d; 2T model release date + benchmarks |
| **Claude Sonnet 5 (Claude Code default) + 1M ctx + $2/$10 promo** | 🟢 NEW | **2026-07-10:** default in Claude Code CLI/IDE/desktop; 1M ctx; promo pricing through **Aug 31** | Adoption curve; whether the promo extends; impact on GH commit share (SemiAnalysis print) |
| **Claude Opus 4.8 / next Anthropic flagship** | ⚪ | No leaks yet | Anthropic dev keynote (rumored H2 2026) |
| **Gemini 3.5 Pro (post-delay Jul 17 target)** | 🟡 | **2026-07-08 DELAYED to Jul 17.** Full architectural rebuild after scrapping 2.5 Pro path; 2M-token ctx + "Deep Think" reasoning layer promised. Alphabet took ~$225B market-cap hit Jun 22 absorbing news. | Whether the Jul 17 target holds; Deep Think benchmark validation; whether Google runs a hiring counter-response to the DeepMind exodus |
| **DeepMind talent exodus (Shazeer + Jumper + Adler + Pritzel out in one week)** | 🟡 NEW | **2026-07-08:** Noam Shazeer → OpenAI; Nobel laureate John Jumper + Jonas Adler + Alexander Pritzel → Anthropic. Talent map collapsing to two labs. | Google counter-hire; whether the exodus continues (retention urgency at DeepMind); Anthropic's utilization of the AlphaFold-lineage talent |
| **WebMCP (open web standard for agents)** | 🟡 | **2026-05-19:** Google proposed WebMCP at I/O — sites expose callable JS/HTML-form tools; browser agents call instead of scrape. Built on Anthropic MCP lineage. Experimental **origin trial in Chrome 149**; Gemini-in-Chrome support "coming soon" | Chrome 149 flag availability date; whether OpenAI adopts MCP-shaped web tooling; first WebMCP-native infra startups (60–90d lag expected); W3C standardization path |
| **MCP 2026-07-28 stateless RC** | 🟡 NEW | **2026-07:** RC out for Jul 28 final spec — MCP goes stateless (round-robin LB, no sticky sessions), adds Tasks extension, MCP Apps (server-rendered UIs), Extensions framework, OAuth/OIDC-aligned auth hardening | Jul 28 final spec; SDK support windows (TypeScript/Python/Rust); how quickly Claude Code + ChatGPT desktop + Gemini CLI move to stateless client behavior; first stateless-native MCP hosting startup |
| **Anthropic Cowork cloud-native (web + mobile)** | 🟡 NEW | **2026-07-07:** Cowork sessions moved off-device to a cloud runtime, cross-device + offline continuation; Reflect analytics dashboard shipped alongside; Claude for Government in beta w/ FedRAMP guide; Cowork usage doubled through Aug 5 | ChatGPT Cowork parity inside 60d; first FedRAMP-authorized agency logo; Reflect analytics adoption + resistance to memory-on requirement |
| **Anthropic Global Workspace / J-lens (mechanistic interpretability)** | 🟡 NEW | **2026-07-06:** Anthropic Jacobian-lens paper identifies "J-space" in Claude mid-layers holding reportable + actionable concepts; caught "blackmail"/"manipulation"/"fake" tokens *pre-output* in red-team runs; **Neel Nanda at DeepMind independently replicated** | First pre-output monitoring product (MCP-server-shaped J-lens gate?); Anthropic-side interp job posts using J-space vocabulary; Dehaene / Naccache formal cross-write |
| **Meta Compute cloud unit + Muse Image + Zuck "hasn't accelerated" admission** | 🟡 NEW | **2026-07-01–07:** Meta reportedly standing up Meta Compute to resell spare AI capacity; Muse Image live across IG/WA/Messenger; Zuck admits agent progress hasn't accelerated at Jul 2 town hall; internal "Watermelon" model claimed to match GPT-5.5 | First Meta Compute customer contract; Watermelon leak / release; whether Muse Image gets a stand-alone API; how the stall admission reads in H2 earnings guidance |
| **Microsoft Claude-in-Copilot + unified app August + 4,800 layoffs** | 🟡 NEW | **2026-07-04–07:** Claude selectable inside Copilot Chat (multi-vendor hedge); 40+ July Copilot updates; unified consumer + enterprise Copilot ships August w/ AutoPilot agents; ~4,800 layoffs incl. 3,200 Xbox through FY27; Copilot team told to "earn the right to exist" | August unified-app launch signals; whether Claude usage inside Copilot outpaces GPT; further Copilot team restructures |
| **Meta TBD Labs comp lift (junior AI bands +20–40% Q2)** | 🟡 NEW | **2026-07-02:** Ruoming Pang $200M package; 8 ex-OpenAI researchers by end of June; OpenAI / Anthropic / Google raised senior IC bands in response; Levels.fyi senior TC now $600K–$795K | Whether comp bands hold in H2; new-grad TC deltas at labs; publicly-visible counteroffers |
| **FDE +729% YoY hiring wave** | 🟡 NEW | **2026-07-08:** 5,330 Apr-2026 listings on Indeed (from 643 Apr-2025); 224 open across 39 companies; median mid $385K / staff $610K / principal $1.2M+; Google + Deloitte = ~40% of postings | Whether "AI Integration Engineer" merges into FDE branding; comp progression Q3; whether Anthropic Solutions + OpenAI Deployment Company staffing waves show up in JD volume |
| **Anthropic Fellows Program (Jul 2026 cohort running)** | 🟢 | **2026-07-01:** July cohort started; follow-on cohort applications open; ~4 months empirical alignment/interp/agents research; historically ~30% convert to FT | Next cohort application window; # of papers published from July cohort; whether J-lens work spins out from Fellows |
| **YC S26 batch + 15-idea RFS + 2026 Demo Day calendar published** | 🟡 NEW | **2026-07-01:** S26 batch RFS emphasizes hardware iteration speed / per-plant agriculture robotics / AI-chip supply-chain software; Demo Day dates published | S26 companies open founding-engineer roles 60–90d out; Work at a Startup filter alerts; whether YC S26 companies dominate infra follow-on rounds by year-end |
| **Nvidia Rubin roadmap on-time + Nemotron 3 Ultra open** | 🟢 | **2026-07-06:** Nvidia publicly rejected SemiAnalysis delay reports; Rubin partner products still H2 2026; Nemotron 3 Ultra released, tied to agent-orchestration platform | First Rubin production benchmark reproduced externally; Nemotron 3 Ultra open-source adoption vs Llama 4 |
| **Omneky + wave of vertical-SaaS MCP servers** | 🟡 NEW | **2026-07-10:** Omneky launched public API + MCP server (agent-callable ad creative); joins wave of vertical SaaS wrapping products as MCP servers | Which vertical SaaS ($20–80M ARR band) ships an MCP server next; whether "MCP server-as-distribution" narrative becomes standard on YC pitch decks by Q4 |
