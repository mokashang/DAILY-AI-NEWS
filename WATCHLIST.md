...
|---|---|---|---|
| **Anthropic IPO — Nasdaq confirmed, October target, $800B–$2T range** | 🟢 NEW | **2026-09-20:** Bloomberg / QZ / Business Today / Yahoo confirmed **Nasdaq** as the listing venue (Sept 13–14); **Goldman + Morgan Stanley + JPMorgan** on the book; $30B+ run-rate, 1,400% YoY, operating profit expected this quarter; valuation range spans **~$800B (Yahoo) → ~$965B post-money → ~$2T (Business Today)** | S-1 filing date; revenue-line-item split (Claude Code vs. API vs. Verticals vs. Enterprise); first-day pop; whether the roadshow language says "no ads" or "no ads today"; role of PwC / JPMorgan / Schwab / BlackRock in the top-10 customer disclosure |
| **Anthropic — "Claude builds Claude" 26% and rising** | 🟡 NEW | **2026-09-20:** Anthropic disclosed (Sept 17–18) that **26% of internal R&D is Claude-led** (0% Feb → 26% Aug); **~30,000 concurrent agents**; **~1B decisions/mo, 1-in-47,000 blocked (0.002%)** by online monitor; 100% offline-reviewed; **third-party evaluators being embedded** | Whether monthly disclosure becomes a cadence; if % crosses 50% before EOY; growth in the offline-reviewer + embedded-evaluator FTE count; whether OpenAI / DeepMind publish equivalents |
| **Anthropic Threat Intelligence Report** | 🟢 NEW | **2026-09-20:** first-named quarterly report — **"Countering misuse of AI: September 2026"** covers Dec 25 → Aug 26; named cases: **China anti-torpedo weapons proposal + Yemen hypersonic glide vehicle concept + Russia autonomous kamikaze drone swarm + Iranian US-Navy targeting roster**; **Chinese labs + Russian hacker groups cut off** | Dec 2026 issue; whether Google / OpenAI publish parallel reports; whether the Nov threat-of-AI Order at CAISI cites these cases; new sanction / cleared-provider role postings |
| **Anthropic — Claude for Financial Advisors** | 🟢 NEW | **2026-09-20:** launched Sept 14; day-one connectors to **Schwab, BlackRock, Vanguard, Addepar, Envestnet, iCapital, Orion, Wealthbox, Wealth.com, Zocks + FactSet + S&P Global + Morningstar** (13-item list); **$70–120/user/month**; human-in-loop preserved for investment recs + client comms | Which vertical is next (Healthcare + Government + Education signal candidates); Fidelity + Morgan Stanley Wealth counter-move; Solutions Engineer / FDE headcount growth on the Anthropic careers page |
| **Anthropic × Novo Nordisk — Claude Science first big-pharma logo** | 🟢 NEW | **2026-09-20:** Sept 16 announcement; Novo will use Claude Science (public beta since Jun 30) + frontier models in R&D; NovoScribe generates clinical study reports in **minutes not months** | Next big-pharma logo; whether "neglected diseases" positioning survives into the S-1; Claude Science's transition from beta → GA |
| **OpenAI — Sponsored Agents inside ChatGPT (live)** | 🟡 NEW | **2026-09-20:** Sept 16 launch test with **Wayfair + Angi** as first advertisers; agent-native ad primitive | Advertiser count + categories over 90d; whether an official Ads SDK ships at DevDay Sept 29; disclosure practices around sponsored content; ad-revenue disclosed in Q4 IPO filing |
| **OpenAI DevDay 2026 (Sept 29, Fort Mason SF)** | 🟡 NEW | **2026-09-20:** T-9 days; keynote livestreams; **DevDay Exchanges** in Bengaluru / Tokyo / Seoul / Paris / Berlin / London / São Paulo / Mexico City to follow | Actual product announcements (predictions: API repricing, Agents SDK 2.x, Ads SDK, Codex Windows/mobile expansion, Realtime v3); public grade-day Sept 30 (see [2026-09-20/03 §3](./2026-09-20/03-practical-skills-and-tools.md#3-devday-watchlist)) |
| **Google — Gemini Enterprise agent-spend caps + $0 base tier** | 🟢 NEW | **2026-09-20:** PAYG pricing + up to 20% token discounts + monthly per-agent spend caps as a first-class feature + $0 base subscription | Whether Anthropic drops Team/Enterprise seat price in response within 60d; agent-FinOps role postings at Google Cloud; whether AWS Bedrock + Azure OpenAI add similar controls |
| **Meta — Project OT abandoned** | 🟢 NEW | **2026-09-20:** Reuters/Engadget confirmed Zuckerberg abandoned the November layoff wave (Project OT) — stated reason **"AI wasn't good enough"**; May cuts (8K + 6K canceled reqs = 14K) stand; 7K redirected to AI teams | Q4 hiring signal from the Applied AI Engineering / Agent Transformation Accelerator XFN teams; whether ex-Meta engineers show up at Anthropic / OpenAI in H2 comp bands |
| **Cognition (Devin) $40B talks** | 🟡 | **2026-09-20:** Bloomberg (August) — early investor talks at $40B+ vs. $26B in May → 55% step-up in <90d | Round close; leader; hiring cadence; whether Devin's coding-agent share holds |
| **Poolside AI — NVIDIA $1B equity at $12B + $6B licensing** | 🟢 NEW | **2026-09-20:** NVIDIA valued Poolside at $12B (direct $1B equity) + $6B tech-licensing deal (non-exclusive) — the strategic-anchor pattern | Whether NVIDIA repeats the pattern with another coding-agent player; Poolside customer logos |
| **Perplexity — NVIDIA in talks at $30B+** | 🟡 NEW | **2026-09-20:** NVIDIA reportedly in talks to invest at $30B+ (late Aug) vs. ~$20B Sep 2025 → ~$23B Jan 2026 (Series E-6) | Round close; Comet browser share vs. Chrome / Edge Copilot; whether NVIDIA's strategic-anchor pattern replicates |
