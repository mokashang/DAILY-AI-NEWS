...
|---|---|---|---|
| **Anthropic run-rate crosses $30B; >1,000 customers at >$1M ARR (2026-07-12 newsroom)** | 🟢 NEW | **2026-07-12:** Anthropic newsroom post reports run-rate revenue "surpassed $30B" (from ~$9B end-of-2025, ~3.3× in 7 months); >1,000 customers spending $1M+/yr annualized; paired with the 3.5-GW Google+Broadcom TPU deal below | Independent verification via Ramp AI Index next drop; whether the $30B lines up with the "October IPO" reporting path (rows below) |
| **Anthropic + Google + Broadcom 3.5-GW TPU deal (Broadcom SEC-filed)** | 🟢 NEW | **2026-07-12:** Multiple gigawatts of next-gen TPU capacity (SEC filing puts it at 3.5 GW) coming online **starting 2027**; sits inside Anthropic's larger $50B US-compute commitment; announced early April, referenced in Jul newsroom expansion | Timeline of first-GW online date; whether Anthropic Colossus tenancy ramps (H100/H200/GB200) in parallel; second Broadcom customer of comparable scale |
| **Together AI $800M Series C at $8.3B — Aramco Ventures lead** | 🟢 NEW | **2026-07-01:** $800M closed at $8.3B post; Aramco Ventures lead + NVIDIA/Vista/General Catalyst/Emergence/SE Ventures/March/Pegatron/Salesforce/S Ventures; bookings >$1.15B/qtr; open-weight usage 3× YoY; 60× cheaper enterprise inference vs closed models; capacity plan ~50× over 5 yrs | Sovereign-compute follow-on rounds (MGX/Norwegian SWF/G42) in AI infra; CoreWeave and Runware comparable rounds; whether Aramco co-leads a US frontier-lab round next |
| **Venice $65M Series A at $1B (privacy-first AI, Sheridan WY, Dragonfly lead)** | 🟢 NEW | **2026-07-06:** two-year-old company; privacy/surveillance-free AI-model router; Wyoming jurisdiction-arbitrage signal | Whether "no-logs" becomes a standard B2B AI-buyer requirement; adjacent privacy-preserving-AI rounds (Duality/Zama/Fhenix) |
| **Bespoke Labs $40M Series A + Taktile $110M Series C (Goldman Growth Equity lead)** | 🟢 NEW | **2026-07-06:** Bespoke = fine-tuning open-weight models for regulated workflows; Taktile = LLM-decisioning for banks/lenders/insurers | Whether Goldman leading Taktile signals the enterprise/bank buy-side is officially validating "regulated agentic"; adjacent rounds in insurance/AML/KYC agents |
| **H1 2026 global venture = $510B (record) — Crunchbase** | 🟢 NEW | **2026-07-12:** surpasses all of 2025's $440B; AI is the plurality; median seed pre-money for AI = $17.9M; median Series B = $143M | Q3 print; whether Series B compression continues; AI share stays above 70% |
...
| Thread | Status | Last move | Watching for |
|---|---|---|---|
| **GPT-5.6 family (Sol / Terra / Luna) — GA 2026-07-10** | 🟢 RESOLVED | **2026-07-10:** OpenAI released Sol (bio/chem/cyber, +54% coding token efficiency per Altman), Terra (mid-cost), Luna (fastest/cheapest) globally, after a ~2-week US-government-requested trusted-partner-only preview. Shipped alongside **ChatGPT Work** — agentic desktop surface merging Codex + 15-integration plugin directory | First head-to-head bench vs Claude Sonnet 5 + Fable 5 (Artificial Analysis expected this week); Sol pricing card; ChatGPT Work adoption metrics; whether Realtime-3 voice ships this quarter |
| **Claude Opus 4.8 / next Anthropic flagship** | ⚪ | No leaks yet | Anthropic dev keynote (rumored June) |
| **Gemini 3.5 (Flash shipped; Pro pending)** | 🟡 | **2026-07-12:** Gemini 3.5 **Pro** now widely reported targeting **GA Wednesday July 17** — ground-up rebuild (not a 2.5 point release), **2M-token context**, **Deep Think reasoning tier gated behind $250/mo Ultra**. No official Google model card, pricing page, or launch post as of last confirmed pull (Jul 7); treat as `[rumor]` until Wednesday. Prior 2026-05-19 RESOLVED status remains for Flash: Gemini 3.5 Flash GA same-day — $1.50/1M in · $9/1M out · $0.15 cached · 1,048,576 in / 65,536 out ctx · text+image+audio+video in | Wednesday's launch post (or slippage); Deep Think API pricing (likely > Opus 4.7); whether Claude/OpenAI cut prices in response; 2M-context repricing of RAG-vs-long-context vocabulary in interviews |
