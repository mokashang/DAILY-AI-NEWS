...
| **OpenAI IPO path (confidential S-1)** | 🟡 SLIPPING | **2026-06-26:** Reuters + Bloomberg Tech report OpenAI is **weighing a 2027 IPO** rather than Q4 2026 (S-1 filed June 8 at $850B–$1T per May-22 tracking). OpenAI says timeline "may be a while." [rumor] | Public S-1; revised target window; whether Microsoft revenue-share disclosure is the gating issue; whether GPT-5.6 GA is required before pricing |
| **Anthropic Oct 2026 IPO path** | 🟡 | **2026-06-27:** still tracking Oct 2026 on Nasdaq; Goldman + JPM + MS; target raise >$60B at $1.05–1.15T secondary-implied. Mythos 5 clearance helps the prospectus. If OpenAI slips to 2027, Anthropic beats them to public markets. | S-1 filing; whether Anthropic publishes the federal-cleared customer list as a positive risk factor; equity-liquidity implications for current employees |
...
| **Trump AI/cybersecurity executive order (pre-release model review)** | 🔴 ACTIVE — CORRECTION | **2026-06-27 CORRECTION:** the May-22 "POSTPONED" entry was wrong. The EO was **signed and is now operative**, requiring up-to-30-day pre-release government access to "covered models" and authorizing Commerce to gate distribution. **2026-06-12:** Anthropic Mythos 5 + Fable 5 disabled under Commerce export-control order. **2026-06-26:** Commerce Sec. Lutnick re-authorizes Mythos 5 for **~100 cleared US institutions**; OpenAI ships **GPT-5.6 Sol limited to ~20 pre-cleared partners** under the same regime. Fable 5 still offline. See [2026-06-27/01 §1–2](./2026-06-27/01-big-lab-moves.md#1-gpt56) | Which startups/agencies appear on the cleared lists (FOIA-able over time); whether Fable 5 returns; whether the ~30-day window tightens or relaxes; pre-deployment-eval hiring at Commerce/MITRE/RAND/Booz/Anthropic/OpenAI |
| **Federal whitelisting as release paradigm** | 🟡 NEW | **2026-06-27:** GPT-5.6 Sol partner-gating (~20 orgs) + Mythos 5 ~100-org clearance establish the new model: **frontier weights flow through a government allow-list, T-1 weights remain broadly available**. See [2026-06-27/01 §2](./2026-06-27/01-big-lab-moves.md#2-mythos5) | Whether OpenAI / Anthropic publish the cleared lists; whether non-US labs (Mistral, Z.ai, Moonshot) emerge as "unrestricted" alternatives; first startups blocked from a frontier deal by being off-list |
